...
RUN DEBIAN_FRONTEND=noninteractive apt-get -y install nginx curl unzip git supervisor php8.1-fpm php-mysql php-redis php-mbstring php-zip php-gd php-xml php-curl
# Install composer
